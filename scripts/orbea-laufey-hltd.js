...
document.addEventListener('DOMContentLoaded', () => {
  ...
  const lavenderSrc = '../images/Orbea_Laufey_H_LTD_lavender_cropped.webp';
  const silverlSrc = '../images/Orbea_Laufey_H_LTD_silver_cropped.webp';
  const copperSrc = '../images/Orbea_Laufey_H_LTD_copper_cropped.webp'
